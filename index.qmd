...
**Utilization Distribution (UD)** function and the **kernel** method

<div style="font-size:60%; color:gray;">
Bandwidth parameter *h* = half the estimated Silverman rules values ((fine-grained scale; functions <span style="font-family:'Courier New', Courier, monospace;">kernelUD</span> and <span style="font-family:'Courier New', Courier, monospace;">getverticeshr</span> from the R package "adehabitatHR", Calenge 2006 and Worton, 1995)
</div>
...
An example of a kernel utilization distribution analysis
<span style="font-size:60%; color:gray;">(modified from Millspaugh et al. 2000 & 2010)</span>
...
Main area: 50% vertices in dark purple; larger area: 95% vertices in light purple
