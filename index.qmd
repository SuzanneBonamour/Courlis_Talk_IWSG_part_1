...
subtitle: |
  <div style="position: absolute; top: -50px; left: -230px; font-size: 0.4em; color: gray; opacity: 0.6;">
...
```{r}
#| echo: false
knitr::include_graphics("no mig.jpg", dpi = 100)
```

The fonctional site around the Nature Reserve
:::
:::
::::
...
## Roosting and foraging areas fluctuating with tide and submersions {.smaller}
...
<div class="smaller">
  ...
  - birds **avoid hunting huts** when hunters are allowed to shoot (at night)
</div>
...
2) limiting the **density** of hunting **huts** (especially in the immediate proximity of the nature reserve).
...
![](lpo_logo.jpg){.absolute top=500 left=0 width="65" height="65"}

![](reserve_logo.png){.absolute top=500 left=70 width="130" height="65"}

![](MNHN-logo.jpg){.absolute top=500 left=200 width="65" height="65"}

![](logo_CESCO.png){.absolute top=500 left=270 width="210" height="65"}

![](Logo-Prefet-de-la-Region-Nouvelle-Aquitaine.png){.absolute top=500 left=485 width="140" height="70"}

![](Logo-FSE-UE-Region-Nouvelle-Aquitaine.png){.absolute top=500 left=625 width="160" height="75"}

![](LIENSs_transp1-e1485208828412.png){.absolute top=500 left=785 width="80" height="75"}

![](fonds-vert_logo.png){.absolute top=500 left=860 width="120" height="75"}
