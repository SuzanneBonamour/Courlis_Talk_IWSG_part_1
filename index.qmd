...
## Roosting ans foraging areas {.smaller data-visibility="uncounted"}
...
Generalized linear mixed model <span style="font-size:60%; color:gray;">(GLMM, package glmmTMB, link function Gamma)</span>
:::
:::
